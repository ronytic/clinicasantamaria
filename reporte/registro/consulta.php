			...
			<fieldset>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        (<?php campos("Izq:","laterorriniaizq","radio","izq",0,array("readonly"=>"readonly","class"=>"c8"));?>
                        <?php campos("Der:","laterorriniader","radio","der",0,array("readonly"=>"readonly","class"=>"c8"));?>)
                        <br>
