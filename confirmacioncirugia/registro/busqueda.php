...
if (!empty($_POST)) {
    ...
    foreach($pq as $p){$i++;
        ...
        $datos[$i]['fechaconsultareal']=$p['fechaconsultareal'];
        $datos[$i]['estado']=$p['fechaconsultareal']!="0000-00-00"?'Revisado':'Pendiente';
    }
	$titulo=array("nombres"=>"Nombres","paterno"=>"Paterno","materno"=>"Materno","ci"=>"C.I.","celular"=>"Celular","sexo"=>"Sexo","estadocivil"=>"Estado Civil","fechaconsultareal"=>"Fecha de Consulta Prequirugica");
	listadoTabla($titulo,$datos,1,"","","",array("Registrar Confirmación"=>"consulta.php"));
}
?>